...
$mail->addReplyTo('kiranpoojary483@gmail.com', 'CodexWorld');
$mail->addAddress('chandramouliganesh97@gmail.com');   // Add a recipient
$mail->addCC('cc@example.com');
$mail->addBCC('bcc@example.com');

$mail->isHTML(true);  // Set email format to HTML

$bodyContent = '<h1>Send Email using PHP from Localhost </h1>';
$bodyContent .= '<p>This is the HTML email sent from localhost using PHP script by <b>Kiran Poojary</b></p>';
